...
const PRODUCTS = { coffee: { barcode: '7290000000015', unit: 7.3, name: 'קפה בדיקה' }, milk: { barcode: '7290000000008', unit: 5, name: 'חלב בדיקה' } };
...
function verifiedRow(data, [product, qty, amount], index, { refused = false, issues = [] } = {}) {
...
function verifiedCredit(data, { number = '22229080', rows = [['coffee', 6, 43.8], ['milk', 1, 5]], docIssues = [], discount = null, rowOptions = {}, verification = true,
